...
The `/api/generate` endpoint uses SSE streaming to progressively deliver signals as they're generated by Claude. This provides:
...
- **Timeout resilience** — 30-second timeout covers the entire stream
...
- **Progressive Streaming UI**: Shows signals appearing in real-time during generation
...
- **Timeout Management**: 30-second timeouts with AbortController for cancellation
